...
//    @Test
//    fun `Bishop cannot move if path is blocked by own piece`() {
//        val chessBoard = ChessBoard.emptyBoard()
//        val bishop = Bishop(true)
//        val blockingPawn = Pawn(true)
//        chessBoard.board[Position('c', 1)] = bishop
//        chessBoard.board[Position('d', 2)] = blockingPawn
//        val from = Position('c', 1)
//        val to = Position('e', 3)
//
//        assertThat(bishop.canMove(from, to, chessBoard)).isFalse
//    }
...
//    @Test
//    fun `Queen available moves with blocking pieces`() {
//        val chessBoard = ChessBoard.emptyBoard()
//        val queen = Queen(true)
//        val blockingPawn = Pawn(true)
//        val opponentPawn = Pawn(false)
...
//            Position('d', 5),
//            // Horizontal
//            Position('c', 4), Position('b', 4), Position('a', 4), Position('e', 4), Position('f', 4),
//            // Diagonal
//            Position('c', 3), Position('b', 2), Position('a', 1), Position('e', 5), Position('f', 6)
//        )
//    }
    @Test
...
//    @Test
//    fun `Rook available moves with blocking pieces`() {
//        val chessBoard = ChessBoard.emptyBoard()
//        val rook = Rook(true)
//        val blockingPawn = Pawn(true)
//        val opponentPawn = Pawn(false)
